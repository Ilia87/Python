...
# x = y = int(input('десятечное число для перевода в ' + str(base) +'-ую систему: '))
# while x > 0:
# 	digit = x % base
# 	print (digit, end='')
# 	x //= base
# print('число ' + str(y) + ' в ' + str(base) +'-ой системе = ' + str(digit))
# print('справочно, число ' + str(y) + ' в' + ' 2-ой: ' + str(bin(y)) + ', 8-ой: ' + str(oct(y)),', 16-ой: ' + str(hex(y)))
